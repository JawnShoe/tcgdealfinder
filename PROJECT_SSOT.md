...
- Repo hygiene Pack B1 (2025-12-23): Isolated 35 root-level one-off scripts (check-_.ts, test-_.ts, verify-db.ts, run-migration.ts, etc.) into a dedicated historical bucket; updated archived doc reference. No production code references. Commit: 52fbf6f.

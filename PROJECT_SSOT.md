...
**ACTIVE WORK**: Track B — UI/SSR Stability Pass (deterministic rendering; no Track A) (PR #109)
...
- Track B — UI/SSR stability pass (2025-12-29): Eliminated key SSR/CSR mismatch sources on `/`, `/top-deals`, and `/watchlist` by making time + viewer-currency dependent rendering deterministic and removing client-side CAD→USD conversion for the Historic column. PR: #109 (open).

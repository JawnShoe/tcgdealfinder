...
- Security Patch Pack: Next 14.2.35 + React2Shell (2025-12-24): Pinned Next.js to exact version 14.2.35 (from ^14.2.33) to address 4 RSC/Server Action CVEs: CVE-2025-66478 (critical RCE), CVE-2025-55184 (high DoS), CVE-2025-55183 (medium source exposure), CVE-2025-67779 (high incomplete fix). Ran npx fix-react2shell-next (reported no vulnerable packages). No runtime code changes. Build/lint verified passing (39 routes). Commit: 17ccf32. PR: [pending].

...
| **Contracts (tooltip/hydration/skeleton) + VISUAL_CONTRACT** | docs/rebuild/CONTRACTS.md + docs/rebuild/VISUAL_CONTRACT.md                                  | docs/rebuild/VISUAL_CONTRACT.md, docs/rebuild/PRD_LITE.md                                             | N          | CONTRACTS.md:26 "See docs/rebuild/VISUAL_CONTRACT.md"; VISUAL_CONTRACT.md governs legacy tooltips                       | CONTRACTS.md: Keep; VISUAL_CONTRACT.md: Keep; VISUAL_CONTRACT.md: Keep (legacy)       |
...
| **UI consistency / tooltip inventory**                       | docs/rebuild/VISUAL_CONTRACT.md + docs/archive/ui-legacy/TOOLTIP_INVENTORY.md                | docs/rebuild/VISUAL_CONTRACT.md                                                                       | N          | VISUAL_CONTRACT.md governs legacy; VISUAL_CONTRACT governs rebuild (explicit scope separation)                          | Both: Keep (scope-separated)                                                          |
...
### docs/archive/ui-legacy/ (2 files)

| File                                        | Purpose                 | Status                 |
| ------------------------------------------- | ----------------------- | ---------------------- |
| docs/rebuild/VISUAL_CONTRACT.md             | Legacy tooltip contract | **Canonical (legacy)** |
| docs/archive/ui-legacy/TOOLTIP_INVENTORY.md | Tooltip audit           | **Reference**          |
...
6. **UI contracts**: VISUAL_CONTRACT.md (legacy) and VISUAL_CONTRACT.md (rebuild) are scope-separated — **Keep both**

...
| `/alerts/unsubscribe` | Redirected     | PORT (API-first)    | `/api/rebuild/alerts/unsubscribe`  | Unsubscribe flow wired; email link compatibility maintained; legacy redirects to rebuild                 | N/A (API only)  | PR #323       |

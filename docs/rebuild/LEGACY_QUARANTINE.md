...
| `/alerts/unsubscribe` | Redirected     | Redirect to rebuild | `/api/rebuild/alerts/unsubscribe`  | API ported (PR #323); page route redirects to rebuild API (token-preserving); compliance preserved                      | N/A             | PR #329       |
...
| `/cards/[cardId]`     | Deleted (404)  | Redirect to rebuild | `/rebuild/listing/[id]`            | Listing detail exists; cardId→listingId mapping deterministic; trust panel + confidence + provenance SSR                | Yes             | PR #325       |
| `/sets`               | Deleted (404)  | Redirect to rebuild | `/rebuild/discovery`               | Discovery route exists; set filter parity; trust moat present                                                           | Yes             | PR #326       |
| `/sets/[setId]`       | Deleted (404)  | Redirect to rebuild | `/rebuild/discovery`               | Discovery route exists; trust moat present; NOTE: set filter not supported (degraded parity)                            | Yes             | PR #327       |

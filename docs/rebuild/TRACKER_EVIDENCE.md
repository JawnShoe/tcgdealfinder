...
| ----------------------------------------------------- | ---- | --------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- |
| uses contracts correctly (hydration/skeleton/tooltip) | #TBD | /rebuild/listing/[id] | Code inspection: page.tsx is server component with no client hooks; loading.tsx uses fixed-height skeleton blocks; no tooltip imports; trust data SSR-only. |

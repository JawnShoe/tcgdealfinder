...
| Visual Contract (Phase-1 Visual Contract)         | #245 | docs/rebuild/VISUAL_CONTRACT.md; docs/rebuild/PRD_LITE.md; docs/rebuild/CONTRACTS.md; docs/rebuild/RELEASE_CHECKLIST.md; docs/rebuild/ADR_LOG.md | Visual Contract added and linked; ADR-0003 records adoption; Doctrine Ratification Gate added to CONTRACTS.md.                                           |

...
console.log("\n=== SUMMARY ===");
console.log(
  `Bad listings correctly blocked: ${badTitles.length - badFailed}/${badTitles.length}`
);
console.log(
  `Good listings correctly allowed: ${goodTitles.length - goodFailed}/${goodTitles.length}`
);
